...
public class DbVersion_Should
{
    ...
    {
        var parseResult = MigrationVersion.TryParse("1", out var version);
    ...
    {
        var parseResult = MigrationVersion.TryParse("1.2", out var version);
    ...
    {
        var parseResult = MigrationVersion.TryParse("10001.020", out var version);
    ...
    {
        var parseResult = MigrationVersion.TryParse("20201208", out var version);
