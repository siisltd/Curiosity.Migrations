...
/// <summary>
/// Test that checks the main flow of migration and tests all cases at the same time.
/// </summary>
public class SqlServerMigrationConnectionBigBangIntegrationTests : IClassFixture<SqlServerMigrationConnectionTestFixture>
{
    private readonly SqlServerMigrationConnectionTestFixture _fixture;

    public SqlServerMigrationConnectionBigBangIntegrationTests(SqlServerMigrationConnectionTestFixture fixture)
    {
    ...
    public async Task BigBangIntegrationTest()
    {
        ...
        try
        {
            ...
            await connection.ExecuteNonQuerySqlAsync("CREATE TABLE dummy (id bigint, val nvarchar(100));", null);
